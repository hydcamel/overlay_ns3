...
% G: the weighted adjacency matrix;
% s: source node index;
% d: destination node index;

% Output:
% spcost: n-dimensional array of s->d distance for each d 
% sp: n-dimensional cell array of s->d shortest path for each d (each path represented as a node
% sequence)
...
% Modify: If e(u,v)=-1, this means there is a zero-weight edge from u to v.
% Yilei Lin, August 9, 2019.
